...
const { cssTheme, wrapper, logo, funcsAside, toDndUploadTrack, toNoteList, toSettings, progressBar, panelList, selectSearch, dndUploadTrack, currentTrackInfo, panelLyrics, dndUploadLyrics, audioPlayerCtrl, basicCtrl, singleSongLoop, pause, play, volume, altCtrl, lineFollow, singleLineLoop, lineOffset, offsetMinus, offsetPlus, queryPopup, queryCtrl, queryCheck, queryAdd, queryClose, noteList, audioPlayer, noteHead, noteBody, settings, defaultMode, defaultLoop, defaultLineFollow } = manufactureDOMs()
